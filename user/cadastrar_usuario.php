        ...
        <form action="cadastrando_usuario.php" class="ls-form row" method="post">
          <fieldset>
            ...
            <?php } ?>
               ...
               <!-- <input class="ls-btn ls-btn-lg ls-ico-user" type="reset" name="cancelar"   value="Cancelar" href="javascript:window.history.go(-1)" class="ls-go-next">
            -->
           <a href="../../TrabalhoFinal/index.html"class="ls-btn-primary ls-btn-lg ls-ico-chevron-left">Voltar</a>
