  ...
  <div class="ls-sidebar-inner">
      ...
      <nav class="ls-menu">
        <ul>
           ...
           <li><a href="../views/movimentacoes/movimentacoes.php" class="ls-ico-hours" title="Clientes">Movimentações</a></li>
           <li><a href="../views/relatorios/relatorios.php" class="ls-ico-stats" title="Relatórios">Relatórios</a></li>
           <li>
      ...
      <div class="container-fluid">
        ...
        <div>
            ...
            <div id="alterar">
              ...
              <a href="usuarios_alterar_senha.php" class="ls-btn-primary-danger" data-ls-module="modal" data-target="#editPassword"> Alterar Senha </a> 
