          ...
          <?php if(isset($_GET['sucesso'])){ ?>    <!-- sucesso ao cadastrar dados de perfil-->
            ...
            <?php } ?>
              ...
              <div align="center" >
                ...
                <table class="ls-table ls-bg-header ls-table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td> <input type="date"  name="data_pagamento"  placeholder="Data Pagamento" ></td>
                      <td></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td> <input type="date"  name="data_vencimento"  placeholder="Data vencimento" ></td>
                      <td></td>
                    </tr>
                ...
                <a href="javascript:window.history.go(-1)" id="cancelar" class="ls-btn-dark ls-btn-lg"> Cancelar</a>
