...
<div>
  <!-- variavel $_SERVER envia o metodo post para a propria pagina no [PHP_SELF] (termo referente a selfie auto) -->
...
<!-- ########################################################################################################## -->
        ...
        <div>       
              ...
              <?php 
                ...
                $query = "SELECT * FROM movimentacoes WHERE CATEGORIA = '$categoria' AND DESCRICAO LIKE '%".$palavra."%' ORDER By idFINANCAS DESC";
                ...
                while ($linha = mysqli_fetch_array($resultado))
                {
                  ...
                  <td class="ls-txt-center"> <span style="color: blue;"><?php echo $linha['CATEGORIA'];?></td> </span> 
                  ...
                  <td class="ls-txt-center"><?php echo $linha['SITUACAO'];?></td> 
                    ...
                    <td class="ls-txt-center"> 
                      ...
                      <a href="alterar_movimentacao.php?editar=<?php echo($linha['idFINANCAS'])?>" class="ls-tooltip-bottom" aria-label="Editar"><i class="ls-ico-edit-admin ls-text-xl"> </i> </a> &nbsp; &nbsp; 
                       ...
                       <a href="" data-ls-module="modal" class="ls-tooltip-bottom" aria-label="Excluir" data-action="../movimentacoes/movimentacoes_opcoes.php?excluir=<?php echo($linha['idFINANCAS']) ?>" data-content="<h2> Deseja mesmo excluir está informação ? </h2> <br><p> Aviso , está ação não pode ser revertida , ao clicar em aceitar os dados serão apagados permanentemente da sua base de dados. </p>" data-title="Excluir" data-class="ls-btn-danger" data-save="Sim" data-close="Fechar"> <i class="ls-ico-remove ls-text-xl"></i></a></td> 
