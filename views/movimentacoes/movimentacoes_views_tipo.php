...
<div>
  ...
  <form id="label" name="busca" method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>?a=buscar" class="ls-form ls-form-inline ">
                ...
                <style type="text/css"> #label{position: absolute; right: 70px;} </style>
              </form><br><br>
...
<!-- ########################################################################################################## -->
        ...
        <div>       
              ...
              <?php 
                ...
                $query = "SELECT * FROM movimentacoes WHERE TIPO = '$tipo' AND DESCRICAO LIKE '%".$palavra."%' ORDER By idFINANCAS DESC";
