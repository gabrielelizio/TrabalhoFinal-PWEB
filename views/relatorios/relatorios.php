                    ...
                    <ul>
                      ...
                      <li>
                        ...
                        <ul>
                          ...
                          <li><a href="../../views/categorias/categorias.php">Categorias</a></li>
                          <li><a href="../../views/formapagamento/forma_pagamento.php">Formas de pagamento</a></li>
              ...
              <main class="ls-main ">
                <div class="container-fluid">
                  ...
                  <table class="ls-table ls-no-hover ">
                    <tr>
                      <td width="600px;">
                        <form action="../movimentacoes/movimentacoes_views_periodo.php" method="post" class="ls-form ls-form-inline">
                      ...
                      <td width="600px;">
                        <form action="../movimentacoes/movimentacoes_views_categoria.php" method="post" class="ls-form ls-form-inline ">
                  ...
                  <table class="ls-table ls-no-hover ls-md-space">
                    <tr>
                      ...
                      <td width="200px;">
                        <a id="nova_movimentacao" class="ls-btn-primary-danger " href="../movimentacoes/movimentacoes.php"> Nova Movimentação</a>
                    </tr>
                    </td>
                  </table>

                  <a id="recarregar" href="../relatorios/relatorios.php" title="Recarregar" class="ls-btn ls-ico-spinner ls-float-right">
                  </a>
                  ...
                  <div>
                    ...
                    <div class="ls-modal" id="filtroSituacao">
                      <form action="../movimentacoes/movimentacoes_views_situacao.php" class="ls-form" method="post">
                ...
                <div class="ls-modal" id="filtroTipo">
                  <form action="../movimentacoes/movimentacoes_views_tipo.php" class="ls-form" method="post">
                    <div class="ls-modal-small">
                      <div class="ls-modal-header">
                        <button data-dismiss="modal">×</button>
                ...
                <?php if (isset($_GET['sucesso1'])) { ?>
                  <!-- sucesso ao alterar dados de perfil-->
                  <br>
                ...
                <div>
                  <table class="ls-table ls-bg-header ls-table-striped ls-table-bordered">
                    ...
                    <tbody>
                      ...
                      $query = "SELECT * FROM movimentacoes WHERE DESCRICAO LIKE '%" . $palavra . "%' ORDER By idFINANCAS DESC";
                      ...
                      while ($linha = mysqli_fetch_array($resultado)) {
                        ...
                        ?>
                        <tr>
                          <td class="ls-txt-center"> <?php echo $linha['DESCRICAO']; ?></td>
                          ...
                          <td class="ls-txt-center">
                            ...
                            <a href="../movimentacoes/alterar_movimentacao.php?editar=<?php echo ($linha['idFINANCAS']) ?>" class="ls-tooltip-bottom" aria-label="Editar"><i class="ls-ico-edit-admin ls-text-xl"> </i> </a> &nbsp; &nbsp;

                            <a href="" data-ls-module="modal" data-action="../movimentacoes/movimentacoes_opcoes.php?excluir=<?php
                                                                                                                              echo ($linha['idFINANCAS']) ?>" data-content="<h2> Deseja mesmo excluir está informação ?
                      </h2> <br><p> Aviso , está ação não pode ser revertida , ao clicar em aceitar os dados serão apagados permanentemente da sua base de dados. 
                      </p>" data-title="Excluir" data-class="ls-btn-danger" data-save="Aceitar" data-close="Fechar">
                              <i class="ls-ico-remove ls-text-xl"></i></a></td>
