  ...
  <div class="ls-notification-topbar">
    ...
    <div data-ls-module="dropdown" class="ls-dropdown ls-user-account">
      ...
      <nav class="ls-dropdown-nav ls-user-menu">
        <ul>
          <li><a href="../TrabalhoFinal/user/usuarios.php">Meus dados</a></li>
          <li><a href="../TrabalhoFinal/user/logout.php">Sair</a></li>
         </ul>
      </nav>
    </div>
  </div>
  ...
  <div class="ls-sidebar-inner">
      ...
      <nav class="ls-menu">
        <ul>
           ...
           <li><a href="../TrabalhoFinal/views/movimentacoes/movimentacoes.php" class="ls-ico-hours" title="Clientes">Movimentações</a></li>
           <li><a href="../TrabalhoFinal/views/relatorios/relatorios.php" class="ls-ico-stats" title="Relatórios">Relatórios</a></li>
           <li>
    ...
    <main class="ls-main ">
      <div class="container-fluid">
        <h1 class="ls-title-intro ls-ico-home"> Pagína Inicial </h1>
      </div>
    </main>
